...
public class Swagger2Config {
	...
	private ApiInfo apiEndPointsInfo() {
		return new ApiInfoBuilder().title("Product Service").description("REST API Documentation")
				.contact(new Contact("Samsher Bahadur Rana", "www.github.com/sbrmgr1", "samsher.rana23@gmail.com"))
